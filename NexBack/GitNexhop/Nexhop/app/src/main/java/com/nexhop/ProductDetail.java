...
public class ProductDetail extends CustomActivity
{
    ...
    int ProductList[]={R.drawable.on_sale_item1,R.drawable.on_sale_item2,R.drawable.on_sale_item3,R.drawable.on_sale_item4,R.drawable.on_sale_item5};


	/** The view that hold dots. */
	private LinearLayout vDots,pDots;
	...
	private void initPager()
	{
        ...
        product_viewpager=(ViewPager) findViewById(R.id.pager1);
		pager.setPageMargin(10);
        product_viewpager.setPageMargin(10);

        product_viewpager.setOnPageChangeListener(new OnPageChangeListener()
        {
            @Override
            ...
            public void onPageSelected(int pos) {
                ((ImageView) pDots.getTag())
                        .setImageResource(R.drawable.dot_gray);
                ((ImageView) pDots.getChildAt(pos))
                        .setImageResource(R.drawable.dot_blue);
                pDots.setTag(pDots.getChildAt(pos));
            }
        ...
        pDots = (LinearLayout) findViewById(R.id.pDots);

		pager.setAdapter(new PageAdapter());
        product_viewpager.setAdapter(new ProductPageAdapter());
	 ...
	 */
	private void setupDotbar(LinearLayout vDots)
	{
	...
	private class PageAdapter extends PagerAdapter
	{
		...
		{
			final ImageView img = (ImageView) getLayoutInflater().inflate(R.layout.img, null);
    ...
    private class ProductPageAdapter extends PagerAdapter
    {
        ...
        {
            final ImageView img = (ImageView) getLayoutInflater().inflate(R.layout.img, null);
            img.setImageResource(ProductList[arg0]);
            container.addView(img,
                    android.view.ViewGroup.LayoutParams.MATCH_PARENT,
                    android.view.ViewGroup.LayoutParams.MATCH_PARENT);
            return img;
